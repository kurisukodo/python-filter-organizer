...
def clean_folder(file_formats: dict, target_directory: str):
    print(f"Starting to clean '{target_directory}' folder")
    ...
    for d_file in dir_content:
        try:
            ...
            print(f"Failed to move file {d_file}")

    print(f"Finished cleaned '{target_directory}' folder")
...
if __name__ == '__main__':
    ...
    if len(file_formats) == 0:
        print("Failed to execute because of missing file formats")
    else:
